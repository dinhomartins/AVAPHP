                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <div class="box-infor-eletricista-aula">
                                <h5 class="btn-aula-inativo" style=""> <a href="aulas-eletricista.php"> Aula 1</a></h5>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="box-infor-eletricista-aula">
                                <h5 class="btn-aula" style=""> <a href="aula2-eletricista.php"> Aula 2</a></h5>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="box-infor-eletricista-aula">
                               <h5 class="btn-aula-inativo" style=""> <a href="aula3-eletricista.php"> Aula 3</a></h5>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="box-infor-eletricista-aula">
                                <h5 class="btn-aula-inativo" style=""> <a href="aula4-eletricista.php"> Aula 4</a></h5>
                            </div>
                        </div>
                    </div>
