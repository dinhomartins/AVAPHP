...
<body>
    ...
    <div class="body-master">
        <div class="side-menu">
            ...
            <div class="sub-menu">
                <i class="fa fa-desktop icone" aria-hidden="true"></i>
                <p>Informações sobre seu curso</p>
            </div>
        ...
        <div class="corpo">
            <div class="content-corpo">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="box-infor-room" style="background-color: #32a852; color: #fff">
                    ...
                    <div class="col-md-3">
                        <div class="box-infor-room">
                            <!-- <i class="fa fa-info-circle fa-1x" aria-hidden="true"  style="margin-right: 10px;" ></i> -->
                            <span> Informações Uteis</span>
                        </div>
                    </div>
                ...
                <!-- FIm divisão aulas -->
                <div class="row">
                    <div class="divisorPadding">
                        <div class="col-md-4">
                            <div class="box-course">
                                <a href="./sala_eletrica/eletricista.php">
                                    <div class="img-icone-eletrica"></div>
                                </a>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="box-course">
                                <div class="img-icone-comando"></div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="box-course">
                                <div class="img-icone-arcond"></div>
                            </div>
                        </div>
                    </div>
